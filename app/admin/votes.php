<?php
    ...
    if(isset($_POST['search'])){
        ...
        // search in vote records
        $selectsql = "SELECT v.vote_id, v.voter_id, vt.voter_name, v.candidate_id, 
                     c.candidate_name, p.position_name, v.vote_timestamp 
                     FROM vote_table v 
                     ...
                     WHERE vt.voter_name LIKE '%".$usersearch."%' 
                     OR c.candidate_name LIKE '%".$usersearch."%' 
                     OR p.position_name LIKE '%".$usersearch."%'
                     ORDER BY v.vote_timestamp DESC";
    }else{
        // show all votes if no search
        $selectsql = "SELECT v.vote_id, v.voter_id, vt.voter_name, v.candidate_id, 
                     c.candidate_name, p.position_name, v.vote_timestamp 
                     FROM vote_table v 
                     JOIN voter_table vt ON v.voter_id = vt.voter_id 
...
<head>
    ...
    <title>Vote Records - Admin Dashboard</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar">
            ...
            <a href="votes.php" class="sidebar-item active"><i class="bi bi-box-seam"></i> Vote Records</a>
        ...
        <main class="col-md-9 col-lg-10 px-4 py-4">
            <div class="container p-5 bg-light">
                <h1 class="mb-4">Vote Records</h1>
                
                <!-- Search Section -->
                <form action="" method="post" class="mb-4">
                    <div class="row g-3">
                        <div class="col-auto">
                            <input type="search" name="searchinput" class="form-control" placeholder="Search records...">
                        </div>
                        <div class="col-auto">
