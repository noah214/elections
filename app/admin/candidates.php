...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar">
            ...
            <a href="candidate.php" class="sidebar-item active">
                            ...
                            <?php foreach ($result as $fieldname) : ?>
                                <tr class="candidate-row" data-id="<?= $fieldname['candidate_id']; ?>" 
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span class="badge <?= $roleClass; ?>"><?= $fieldname['college']; ?></span>
                                    </td>
                                    <td>
...
function deleteCandidate(id, name) {
    ...
    document.getElementById('deleteCollege').value = college;
    document.getElementById('deleteImage').textContent = image;
